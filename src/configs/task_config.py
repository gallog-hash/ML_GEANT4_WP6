...
class GenerationConfig(PostTrainingConfig):
    ...
    input_mode: str = "downsample"  # "downsample" or "direct"
    lowres_data_dir: Optional[str] = None  # For direct mode
    lowres_data_file: Optional[str] = None  # For direct mode
